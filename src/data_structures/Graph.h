...
class Vertex {
public:
    explicit Vertex(T in, double lat = 0, double lon = 0, std::string lab = "");
...
template <class T>
Vertex<T>::Vertex(T in, double lat, double lon, std::string lab): info(in), latitude(lat), longitude(lon), label(std::move(lab)) {}
/*
...
template <class T>
void Vertex<T>::setLatitude(double lat) {
    this->latitude = lat;
}

template <class T>
void Vertex<T>::setLongitude(double lon) {
    this->longitude = lon;
}

template <class T>
void Vertex<T>::setLabel(std::string lab) {
    this->label = lab;
}
